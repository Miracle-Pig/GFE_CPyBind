...
//! 自定义场
GFE_API void SetData_Custom(shared_ptr<DB>, int frame, string var, string name, string expression, vector<data_t>&& data);
GFE_API vector<GFE::data_t> GetData_Custom(shared_ptr<DB>, int frame, string var);
GFE_API std::set<string> GetAllCustomVar(shared_ptr<DB>);
GFE_API std::set<string> GetAllCustomName(shared_ptr<DB>);
GFE_API std::set<string> GetAllCustomExpr(shared_ptr<DB>);
GFE_API std::string GetCustomExpr(shared_ptr<DB>, std::string name);
GFE_API int GetCustomFramesNum(shared_ptr<DB>, std::string var);
GFE_API void ClearCustomOutput(shared_ptr<DB>);
GFE_API int GetCustomVarType(shared_ptr<DB>, std::string var);
GFE_API void RemoveCustomDataByName(shared_ptr<DB>, std::string name);
GFE_API void RemoveCustomDataByVar(shared_ptr<DB>, std::string name);
